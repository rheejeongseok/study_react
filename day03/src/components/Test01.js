...
const Test01Sub = (props) => {

   return(
      <div>
         이름은 {props.name}({typeof props.name})
         나이느 {props.age} ({typeof props.age})
      </div>
   )
...
const Test01 = () => {
   ...
   const data1 = {name:"Dog", age:3}
   const data2 = {name:"Cat", age:5}

   return (
      <div className="Test01">
         <Test01Sub name="강호동" age={30} />
         <Test01Sub name="유재석" age={"20"} />
         <Test01Sub name={data1.name} age={data1.age} />
         <Test01Sub name={data2.name} age={data2.age} />
         <Test01Sub {...data1} />
         <Test01Sub {...data2} />
         <ul>
            {
